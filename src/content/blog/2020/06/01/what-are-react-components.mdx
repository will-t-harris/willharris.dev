...
[We previously discussed how to render elements in React using JSX](https://bikesandbytes.net/rendering-elements-with-jsx).
...
[Next we will cover React state](https://bikesandbytes.net/what-is-react-state), a feature that allows us to change the output of components over time in response to changes in our application's data.
