...
[Last week we introduced JSX](https://bikesandbytes.net/jsx-basics) and discussed how it is a syntax extension to JavaScript that makes life easier when writing React code.
